...
public class EditPrescription extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
//        Toast.makeText(getBaseContext(), "Creating Patient failed", Toast.LENGTH_LONG).show();
    ...
    private void storeprescription() {
        ...
        try {
            ...
            finalJS.put("patientId", getIntent().getStringExtra("pID"));
...
//                            if (status.equals("CREATED")) {
                                Toast.makeText(getBaseContext(), "Successfully edited prescription ", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(getBaseContext(), ShowPatients.class);
                                startActivity(intent);
//                            }
//
